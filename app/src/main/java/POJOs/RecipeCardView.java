...
public class RecipeCardView {
    ...
    public List<String> getRemainingIngredients() {
        return remainingIngredients;
    }

    public void setRemainingIngredients(List<String> remainingIngredients) {
        this.remainingIngredients = remainingIngredients;
    }
